...
import com.github.qywx.core.request.WxTag;
import com.github.qywx.core.response.Response;
import com.github.qywx.core.response.wxtag.TagRes;
...
public class WxTagAPI {
     ...
     */
    public static Integer createTag(WxTag wxTag,String accessToken) throws RCodeException{
     ...
     * @throws RCodeException
     */
    public static Response updateTag(WxTag wxTag,String accessToken) throws RCodeException{
     ...
     * @throws RCodeException
     */
    public static TagRes getTagUsers(Integer tagid, String accessToken) throws RCodeException{
        TagRes tagRes = null;
        ...
        if(httpResult.getStatus()==200){
            JSONObject jo =JSON.parseObject(httpResult.getData());
            tagRes = JSON.toJavaObject(jo,TagRes.class);
